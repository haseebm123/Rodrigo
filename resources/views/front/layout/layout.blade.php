                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                ...
                                <div class="dropdown-divider"></div><a class="dropdown-item"
                                    ...
                                    Logout</a>
                                     <div class="dropdown-divider"></div><a class="dropdown-item"
                                    href="javascript:;"><i class="feather icon-settings"></i>
                                    Setting</a>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title"
                            data-i18n="User">Calculator</span></a>
                    <ul class="menu-content">
                        <li class="@if (Route::currentRouteName() == 'car-loan-calculator' || Route::currentRouteName() == 'calculate.car.loan') active @endif"><a
                                href="{{ route('car-loan-calculator') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="List">Car Loan</span></a>
                        </li>
                        <li class="@if (Route::currentRouteName() == 'investment.calculator' || Route::currentRouteName() == 'calculate.investment') active @endif"><a
